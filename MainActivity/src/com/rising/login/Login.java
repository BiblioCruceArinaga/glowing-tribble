...
//Clase login. Permite al usuario introducir correo electr√≥nico y contrase√±a, registrarse o recuperar 
//la contrase√±a olvidada.
...
public class Login extends FragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState){
		...
		//  Acciones al presionar el bot√≥n de nombre Login
		...
		//Acciones al presionar sobre el bot√≥n de Facebook
    ...
    public void errLogin(int code){
		...
		Log.i("EntrÛ", "EntrÛ 1, cÛdigo: " + code);
    ...
    //  Este m√©todo valida que no haya ningun campo en blanco, 
    ...
    //  Este m√©todo valida que las contrase√±as sean iguales
    ...
    public int loginStatus(String username, String password) {
		...
		if (jData!=null && jData.length() > 0){
			...
			//  Aqu√≠ se valida el valor obtenido
