...
public class MainActivity extends Activity{
	...
	//MÃ©todo que controla el dialog de la cuenta atrï¿½s
	private void DialogCountdown(){
		...
		//Cambia el tamaï¿½o de la ventana de dialogo
	...
	// Habilita o deshabilita elementos segï¿½n estï¿½ o no activado el metrï¿½nomo
